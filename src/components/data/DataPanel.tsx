...
function FieldItem({ field, onDragStart, onDoubleClick }: FieldItemProps) {
  return (
    <div
      ...
      className="flex items-center gap-2 px-2 py-1.5 hover:bg-gray-800/50 rounded cursor-grab active:cursor-grabbing group"
    >
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-3 border-b border-gray-800">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h2 className="text-sm font-semibold text-gray-300">{dataset.name}</h2>
        </div>
      ...
      <div className="p-2 border-b border-gray-800">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-sm bg-gray-800/50 border border-gray-700 rounded focus:border-ray-500 focus:outline-none text-gray-300 placeholder-gray-500"
          />
        </div>
      </div>
